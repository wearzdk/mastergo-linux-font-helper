...
# 打包 amd64
cd ../bin
tar -czf ../output/mastergo-font-linux-amd64.tar.gz ./mastergo-font-linux-amd64 ./install.sh ./mastergo-font.service
cd ../hack

# 打包 arm64
cp ./mastergo-font-linux-arm64 ../bin
cd ../bin
tar -czf ../output/mastergo-font-linux-arm64.tar.gz ./mastergo-font-linux-arm64 ./install.sh ./mastergo-font.service
cd ../hack

# 打包 i386
cp ./mastergo-font-linux-386 ../bin
cd ../bin
tar -czf ../output/mastergo-font-linux-386.tar.gz ./mastergo-font-linux-386 ./install.sh ./mastergo-font.service
cd ../hack
